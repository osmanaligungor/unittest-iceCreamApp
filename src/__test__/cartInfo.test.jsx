...
describe("CartInfo Component Tests", () => {
  ...
  test("dispatches createOrder action and shows toast notification on button click", () => {
    const cart = [
      ...
      { id: 2, name: "Product 2", price: 30, amount: 2 },
    ];
  ...
  test("shows free shipping message when subtotal is greater than or equal to 150", () => {
    const cart = [{ id: 1, name: "Product 1", price: 150, amount: 1 }];
